...
return [
    ...
    'return' => [
        ...
        'cancelled' => 'El pago no se completó. Podés reintentar mientras el pedido siga pendiente.',
    ...
    'errors' => [
        ...
        'access_denied' => 'No tenés permiso para pagar este pedido.',
        'gateway' => 'El proveedor de pagos no pudo iniciar la sesión de checkout. Intentá de nuevo.',
