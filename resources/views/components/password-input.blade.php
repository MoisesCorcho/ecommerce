...
<div>
    ...
    <div class="relative" x-data="{ show: false }">
        ...
        <input
            ...
            {{ $attributes->merge(['class' => "w-full border {$borderClass} bg-silk-cream py-3 " . ($showLockIcon ? 'pl-11' : 'px-3') . ' pr-11 text-body-md text-intense-cocoa transition-colors focus:border-intense-cocoa focus:outline-none']) }}
        >
