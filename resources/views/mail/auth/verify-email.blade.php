...
# {{ __('auth.emails.verify_email.greeting', ['name' => $user->name ?? '']) }}

{{ __('auth.emails.verify_email.line_1') }}

<x-mail::button :url="$url" color="primary">
{{ __('auth.emails.verify_email.action') }}
</x-mail::button>

{{ __('auth.emails.verify_email.line_2') }}
