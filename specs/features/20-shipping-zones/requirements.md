...
* **R15 — Desajuste de moneda de carrito vs país:** SI un carrito en moneda `COP` intenta enviarse a un país extranjero sin tarifa en COP, EL SISTEMA DEBE validar y advertir al usuario la incompatibilidad de moneda para ese destino.
