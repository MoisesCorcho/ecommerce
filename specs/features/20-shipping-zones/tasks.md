...
> **Criterios EARS:** [`requirements.md`](requirements.md) · **Diseño:** [`design.md`](design.md)

---

## Fase 1: Configuración y Capa de Dominio (TDD)

- [ ] **1.1 Matriz de Zonas en Configuración** `_(cubre R1, R5, R6, R7, R8, D1, D2, D3)_`
...
- [ ] **1.2 Excepción de Destino no Soportado** `_(cubre R13, D3)_`
...
- [ ] **1.3 Tests Unitarios de `ShippingCostService` (RED)** `_(cubre R1, R2, R5, R6, R7, R8, R13, D8)_`
...
- [ ] **1.4 Refactorización de `ShippingCostService` (GREEN)** `_(cubre R1, R2, R5, R6, R7, R8, R13, D8)_`
...
- [ ] **2.1 Actualizar `ValidateCartForCheckoutAction`** `_(cubre R2, R9, R11)_`
...
- [ ] **2.2 Actualizar `CreateOrderFromCartAction`** `_(cubre R2, R3, R4, R13, D7)_`
...
- [ ] **2.3 Tests de Feature para Acciones de Pedido** `_(cubre R3, R4, R13)_`
...
- [ ] **3.1 Reactividad en Livewire `checkout-page.php`** `_(cubre R9, R11, R12)_`
...
- [ ] **3.2 Integración Frontend en `checkout-page.blade.php`** `_(cubre R10, R14, D4)_`
...
- [ ] **3.3 Feedback de Destino no Soportado en UI** `_(cubre R13)_`
...
- [ ] **4.1 Tests de Integración Livewire** `_(cubre R5, R6, R9, R12)_`
  - Crear `tests/Feature/Orders/ShippingZonesCheckoutTest.php`.
...
- [ ] **4.2 Formato y Calidad de Código**
...
- [ ] **4.3 Preflight Audit & Checklist de QA**
